...
import "../src/UltraSimpleFactory.sol";

contract DeployUltraSimpleScript is Script {
    function run() external {
        ...
        console.log("Deploying UltraSimpleFactory...");
        
        // Deploy the ultra simple factory
        UltraSimpleFactory factory = new UltraSimpleFactory();

        vm.stopBroadcast();

        console.log("=== Deployment Results ===");
        console.log("UltraSimpleFactory deployed to:");
